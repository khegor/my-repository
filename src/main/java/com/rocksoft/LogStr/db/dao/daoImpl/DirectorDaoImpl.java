...
import com.rocksoft.LogStr.db.dao.daoC.DirectorDao;
...
public class DirectorDaoImpl extends AbstarctDao implements DirectorDao {
    ...
    public void createDirector(Director director) {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("INSERT INTO directors (NAME, SURNAME, ESTABLISHED_POST, DATE_OF_BIRTH) VALUES (?, ?, ?, ?)");
    ...
    public Director getDirectorById(long id) {
        ...
        try {
            connection = getConnection();
            preparedStatement = connection.prepareStatement("SELECT * FROM directors D JOIN ADDRESSES A ON A.ID=D.ADDRESSES_ID WHERE D.ID = ?");
    ...
    public void updateDirector(Director director) {
        ...
        try {
            connection = getConnection();
            preparedStatement = connection.prepareStatement("UPDATE directors SET NAME = ?, SURNAME = ?, ESTABLISHED_POST = ?, DATE_OF_BIRTH = ? WHERE ID = ?");
