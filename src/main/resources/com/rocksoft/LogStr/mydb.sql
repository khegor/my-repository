...
CREATE TABLE IF NOT EXISTS `mydb`.`ORDERS` (
  ...
  `MODIFIED_AT` VARCHAR(45) NOT NULL DEFAULT 'CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP',
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `ID_UNIQUE` (`ID` ASC),
  UNIQUE INDEX `OPERATION_TYPE_UNIQUE` (`OPERATION_TYPE` ASC),
  INDEX `fk_ORDER_LOGISTS1_idx` (`LOGISTS_ID` ASC),
  CONSTRAINT `fk_ORDER_LOGISTS1`
